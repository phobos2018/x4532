...
var _this = this;
var log = require('ololog'), ansi = require('ansicolor').nice, chai = require('chai'), expect = chai.expect, assert = chai.assert, testTrade = require('./test.trade.js');
module.exports = function (exchange, symbol) { return __awaiter(_this, void 0, void 0, function () {
    var trades, now, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!exchange.has.fetchMyTrades) return [3, 2];
