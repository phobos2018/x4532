    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if ('info' in balance) {
                    result = currencies
                        .filter(function (currency) { return (currency in balance) &&
                        (typeof balance[currency]['total'] !== 'undefined'); });
                    if (result.length > 0) {
                        result = result.map(function (currency) { return currency + ': ' + balance[currency]['total']; });
...
//# sourceMappingURL=test.fetchBalance.js.map