...
var _this = this;
var log = require('ololog'), ansi = require('ansicolor').nice, chai = require('chai'), expect = chai.expect, assert = chai.assert, testOrder = require('./test.order.js');
module.exports = function (exchange, symbol) { return __awaiter(_this, void 0, void 0, function () {
    var orders, now, i, order;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!exchange.has.fetchClosedOrders) return [3, 2];
                return [4, exchange.fetchClosedOrders(symbol)];
            case 1:
                orders = _a.sent();
