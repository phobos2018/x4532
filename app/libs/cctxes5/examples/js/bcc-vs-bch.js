...
(function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        var ids, exchanges, id, key, table;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4, Promise.all(ids.map(function (id) { return __awaiter(_this, void 0, void 0, function () {
                            var exchange, currentProxy, maxRetries, numRetries, e_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                ...
                case 1:
                    ...
                    table = ccxt.exchanges.map(function (id) {
                        console.log(id);
                        var exchange = exchanges[id];
                        if (exchange.currencies) {
                            var hasBCC = exchange.currencies.includes('BCC');
                            var hasBCH = exchange.currencies.includes('BCH');
                            var hasBoth = (hasBCC && hasBCH);
                            return {
                                id: id,
...
//# sourceMappingURL=bcc-vs-bch.js.map