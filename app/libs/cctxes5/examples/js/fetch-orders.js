...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, exchange.fetchOrders()];
                case 1:
                    orders = _a.sent();
                    log(asTable(orders.map(function (order) { return ccxt.omit(order, ['timestamp', 'info']); })));
                    return [4, exchange.fetchOrder(orders[0]['id'])];
                case 2:
                    order = _a.sent();
                    log(order);
                    return [2];
