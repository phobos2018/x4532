...
var printTicker = function (id, symbol) { return __awaiter(_this, void 0, void 0, function () {
    var exchangeFound, exchange, markets, ticker;
...
(function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(process.argv.length > 3)) return [3, 2];
                    id = process.argv[2];
                    symbol = process.argv[3].toUpperCase();
                    return [4, printTicker(id, symbol)];
                case 1:
                    _a.sent();
                    return [3, 3];
                case 2:
...
//# sourceMappingURL=live-ticker.js.map